...
# Set filepath equal to Macro_SP_MoM.csv location
r  = getwd()
setwd(r)
...
ggplot(para_five_df, aes(x = 1:11)) +
  ...
  labs(title = 'All Patameters Over Five Year Bins') +
...
ggplot(para_ten_df, aes(x = 1:6)) +
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  labs(title = 'All Patameters Over Ten Year Bins') +
  xlab('Bins') +
  ylab('Parameter Values')
...
ggplot(para_five_df, aes(x = 1:11)) +
  ...
  scale_x_continuous(breaks = 1:11, labels = Bins_Five) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  labs(title = 'Select Patameters Over Five Year Bins') +
  xlab('Bins') +
  ylab('Parameter Values')
...
ggplot(para_ten_df, aes(x = 1:6)) +
  ...
  scale_x_continuous(breaks = 1:6, labels = Bins_Ten) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  labs(title = 'Select Patameters Over Ten Year Bins') +
  xlab('Bins') +
  ylab('Parameter Values')
