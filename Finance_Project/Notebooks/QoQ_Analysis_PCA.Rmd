...
df_7pcs <- cbind(SP500, pca$x[,1:7]) 

# Create regression model
pca_model <- lm(SP500 ~., data = df_7pcs)
summary(pca_model)
...
pca_model_cv <- train(SP500 ~., data = df_7pcs, 
                   method = "lm",trControl = train.control)
...
# Lasso regression
model <- cv.glmnet(x, y, scale=TRUE, alpha = 1, nfolds = 5, type.measure="mse", family="gaussian") # Lasso when alpha=1
